...
class Time:
    ...
    def __str__(self):
        return "%02.0f:%02.0f:%02.0f"%(
               self.hour,self.minut, self.second)
...
class Watch:
    ...
    def print_time(self):
        ...
        print """time in watch is %02.0f:%02.0f:%02.0f 
        (real time spent %f = diff %f)"""%(
                 self.present_time.hour,
                 self.present_time.minut, 
                 self.present_time.second, 
                 offset, 
                 offset-self.present_time.internal_seconds)
