...
\emph{Greenlets}-versionen går den anden vej, og implementerer CSP processer som user-level tråde. Herved kan man have utroligt mange samtidige tråde, der er hurtige at skifte mellem og som er meget lidt ressourcekrævende. \fxnote*{godt til simuleret parallelitet - beware!!!!}{Generelt er \emph{greenlets}-versionen god til ''simuleret parallelitet'', dvs. hvor processerne eksekveres samtidigt, men hvor kun en proces er aktiv af gangen. Dette er specielt relevant  hvis man ønsker at bruge ideerne bag \csp til at modellere processer der interagere med hinanden, men hvor store dele af koden ikke behøves at køre parallelt.}
