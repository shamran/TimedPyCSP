...
I \pycsp findes der tre metoder til at afvikle processer. \code{Parallel}-kaldet benyttes til samtidig afvikling af processer, \code{sequence}-kaldet benyttes når man ønsker at afvikle processer sekventielt og \code{spawn} bruges til planlægge kørsel af processer ved at lægge dem på \sched eren. 
