...
For ikke unødigt at give vores version en fordel har vi valgt at ændre dummyprocessen, så også \code{greenlets}-versionen kan blive færdig. Vi har ikke mulighed for i \code{greenlets}-versionen manuelt at stoppe eksekveringen af processen, og lade den  blive placeret på \code{next}-listen. Den eneste måde for en proces at komme på denne liste er efter at have kommunikeret. Vi ændre derfor dummyprocessen til et dummynetværk bestående af to processer, der hver foretager et stykke arbejde og kommunikere som vist i \cref{dummy2}. I dette netværk findes der to dummyprocesser der skiftes til at sende hinanden den akkumulere tid de har været aktive fordi de efter hver periode sender den akkumulere tid til den anden dummyproces, vil den ene hele tiden skulle vente, for så at blive lagt på \code{next}-listen. Dermed  indgår dummyprocesserne  på lige fod med alle andre aktive processer i netværket..
