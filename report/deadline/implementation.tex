...
\begin{figure}
 \begin{center}
  ...
  \caption{Et generator/arbejder/forbruger -netværk. Pil op indikere hvornår processen er klar til at blive eksekveret. Pil ned indikere en deadline for processen. De stiplede pile i proces B$_1$ og B$_2$ til t$=5$ viser en kunstig prioritet på baggrund af B$_3$'s deadline. Den lille stiplede pil mellem  B$_1$ og B$_2$ i t$=2$ og mellem B$_2$ og B$_3$ i t$=6$ viser kommunikation mellem processerne.}
