...
Der findes derfor fordele og ulemper ved både \code{greenlets}-versionen og \code{process}-versionen. Derfor har vi valgt at implementere begge versioner for i evalueringen at sammenligne dem med RTP-versionen.
