...
De enkelte processer foretager ikke selve arbejdet, men har i stedet tilknyttet et tidsrum,som vi forventer arbejdet i processen vil tage. Hver proces venter ved hjælp af\code{time.sleep}, i et tidrum normaltfordelt omkring for at emulere den tid arbejdet processen er låst. Når 
