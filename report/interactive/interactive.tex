...
I RTP versionen er \sched en baseret på EDF, som kun tager hensyn til processernes deadline når der beregnes prioriteter. Vi skal dermed bruge en anden skemaplanlægningsalgoritme, for også at kunne håndtere at udvikleren skal kunne definere prioriteter. I implementeringen af \sched en i \code{RTP}-versionen, konverteres deadlines til prioritetet. Vi behøver derfor ikke bruge en helt ny skemaplanlægningsalgoritme, men kan udvide EDF, så den også kan planlægge processer hvor udvikleren definere en prioritet.

For at udvide \sched en skal vi definere den indbyrdes relation mellem deadlines og udvikler-prioriteter. Baseret på eksemplet kan vi se at udvikler"-prioriteterne, der er tilknyttet en af processerne skal gå forud for de processer der blot har tilknyttet en deadlines. Vi kan dermed bruge den samme 
