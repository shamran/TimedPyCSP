...
%book%article
  ...
  \hfuzz=3pt
  \setlrmarginsandblock{4.3cm}{3cm}{*}
  \setulmarginsandblock{3cm}{4.3cm}{*}
...
\usepackage{hycolor}
\usepackage[ danish,layout=margin,innerlayout=inline]{fixme} % til at skrive \fixme kommentarer til sig
