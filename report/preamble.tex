...
draft,% Når man skal skifte kompileringsmetode mellem draft og final skal man 
...
\fxfatal[layout=index,target=cite]{Brian: Hvad er din holdning til litteraturhenvisninger.}
