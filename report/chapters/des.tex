...
\lstinputlisting[firstline=132, lastline=152,numbers=left, float, label=fig:scheduling, caption=Uddrag af Scheduler]{/home/shamran/pycsp/branches/TimedPyCSP/pycsp/greenlets/scheduling.py}\inline{Koden skal evt flyttes ind i texfilen for at sikre ensartethed }
 ...
 \item \code{blocking}: Processer der venter på IO operationer, er ikke klar til at blive scheduleret, men heller ikke afsluttet. Scheduleren kan derfor ikke schedulere dem, men holdes styr på antallet af ventende processer vha. denne variabel. 
\end{list}

Scheduleren itererere nu gentagende gange igennem alle tre lister, indtil de alle er tomme, og der ikke er nogle processer der er blokeret, og venter på en IO operation. 
