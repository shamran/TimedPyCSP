...
opdatering\inline{bedre ord} af fisk og hajer kunne risikere en race 
...
kunder, indtil bankeprocessen modtager det andet kald fra barrieren(se \cref{bank-alternation-imp})\inline{lang uklar sætning, omformuler S: bredre?}. 
...
tidsskridt\inline{lang uklar sætning - s:bedre?}. Vi kan bruge samme analogi til at 
...
formål er at vedligeholde køen\inline{bedre brug af ordet liste? s: bedre?}. For nyligt\footnote{d. 22. december 2009} er 
