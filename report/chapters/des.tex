...
igen før processerne kan begynde en ny iteration \fxnote[inline]{pseudo kode 
eksempel?}
...
I \pycsp,\fxnote{hvorfor?- kan man lave child proces der køre i samme 
parallel kald som dets parent?} er standard metoden\fxnote{set fra 
kodeeksempler}, at modellere mere statiske processer, gerne med en source- og sinkproces, og lade arbejdet flyttes mellem processerne igennem kanaler. I \pycsp modellen fungere generatorprocessen stadigt fungere som en source, men vi introducerer en 
