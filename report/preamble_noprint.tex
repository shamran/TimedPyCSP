...
%book%article
  ...
  \hfuzz=3pt
  \setlrmarginsandblock{3.75cm}{3.75cm}{*}
  \setulmarginsandblock{3.75cm}{3.75cm}{*}
  \setheadfoot{2.3cm}{2cm}
...
\hyphenation{trans-port-bånd-et tit-len mo-del-len pro-du-ce-rer an-svars-hav-ende om-for-deles for-bind-elses-mulig-heder ska-ber æn-dring-er net-værks-en-hed-er peer backup backup-system fast-track backup-systemer nabo-peers frame-work efter-som Grund-lag-et plads-effek-tivi-teten audits soft-ware dead-line-Excep-tion prio-ri-tets-in-ver-te-ring prio-ri-tets-ned-arv-ning dead-line dead-line-Excep-tion}
...
\usepackage{hycolor}
\usepackage[final, danish,layout=margin,innerlayout=inline]{fixme} % til at skrive \fixme kommentarer til sig
