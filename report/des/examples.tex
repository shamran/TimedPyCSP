...
\subsubsection{Før introduktion af et tidsbegreb i \csp} For at simulere Wa-Tor 
...
worldpartprocesserne. Alternativt kunne man have to barriereprocesser; en til 
synkronisering af worldpart med vizualize, samt en som 
worldpart-processerne bruger til synkroniseringen af opdatering af 
...
kø for at blive serviceret. Dette  svare til en M/M/1 kømodel\inline{motivér}. Det er igen et tilfældigt tidsrum som kunden bruger på at blive 
...
\fxnote*{Omskrives}{Ved at se på implementeringen af de to eksempler af kunder i en bank sammenholdt med implementeringen i \simpy, kan man se at de egner sig godt til 
...
håndtere køen. \inline{Uddyb lidt om ressource}I \pycsp modelleres servicedisken som en separat proces, og 
...
kunder banken modtager. \fxnote*{giver mening?}{Dette medfører så at det ikke længere er en teoretisk korrekt M/M/1 kømodel, da denne specifikt angiver at køen skal have mulighed for at have uendelig længde. I praksis er det ikke et problem da vi blot kan ræsonnere os frem til at køen ikke bliver fuld.}
