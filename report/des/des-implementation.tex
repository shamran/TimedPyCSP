...
Denne ekstra tråd til håndtering af tid i et blokeret kald er overflødig i \des. For at tiden skal tælles op må ingen processer være blokeret; de skal i stedet befinde sig i timers listen eller vente på kommunikation. Så længe der findes blokerede processer venter \sched en på dem, uden at tiden tælles op og de ventende  processer..
