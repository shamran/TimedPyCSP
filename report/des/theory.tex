...
\end{otherlanguage}\fxnote{Er det korrekt citeret med brug af \ldots?}
...
Når \des indføres, ændres tiden, \ikkef{så timeout-guarden opererer på tidsskridt fremfor en tidsperiode}. Vi går derved fra en situation hvor en timeout-guard f.eks. er villing til at vente i fem sekunder, til at den nu er villig til at vente i 5 tidsskridt. Denne ændring virker umiddelbart simpel, men introducerer et problem i forhold til hvornår timeout-guarden vælges. En proces kan nu ønske at kommunikere i indeværende tidsskridt men ikke i det efterfølgende. Vi kan dog ikke i tidsskridtet evaluere om kommunikation er muligt. Dette skyldes, at tiden står stille mens processerne er aktive, så selvom kommunikation ikke er muligt på ét tidspunkt i tidsskridtet, så kan en efterfølgende begivenhed i samme tidsskridt muliggøre kommunikation.
