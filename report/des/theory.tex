...
\fxnote{taget fra implementering - skal det bruges her eller slettes?}\begin{shaded}
Vi ønsker at introducere diskret tid som et alternativ til realtid. Med for have mulighed for at kunne foretage simuleringer, hvor man bruger \csp som model for systemet. Vi ønsker desuden at man med vores model kan udfase brugen af barrierer, samt kunne benytte den underliggende parallelitet i \csp til at øge hastigheden af de simulere modeller, hvis de er begrænset af beregningskapaciteten.
\end{shaded}
