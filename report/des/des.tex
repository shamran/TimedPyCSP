...
\label{chap:des}
Det første anvendelsesområde vi vil kigge på, er simulering i diskret tid. Vi vil i dette kapitel gennemgå, hvad simuleringer kan bruges til, med fokus på discrete event simulation (\des). Indenfor \des vil vi redegøre for hvilke problemstillinger, vi skal tage højde for, for at kunne implementere \des i \pycsp. 
