...
\label{chap:des}
\thispagestyle{empty}
Det første anvendelsesområde vi vil kigge på, er simulering i diskret tid. Vi vil i dette kapitel gennemgå, hvad simuleringer i diskret tid kan bruges til, samt redegøre for hvilke problemstillinger, vi skal tage højde for, for at kunne implementere diskret simulering i \pycsp. 

Overordnet set har simuleringer længe været et værdifuldt værktøj til at klarlægge, hvordan et system fungerer og er specielt brugbart til at repræsentere systemer, hvis 
...
\item Mulighed for at opsamle statistisk data fra simuleringen. 
\end{enumerate}
