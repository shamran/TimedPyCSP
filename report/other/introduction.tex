...
\item \textbf{\code{Skrivemaskine-font}} markerer i dette speciale de  variabelnavne, funktioner,  klasser og moduler der er der er specifikke for Python og \pycsp.
\end{list}
