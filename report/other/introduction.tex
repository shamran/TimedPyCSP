...
%Baseret på en gennemgang af de tre anvendelsområder har vi har vist at de falder ind under to seperate tidsmodeller som vi har udvidet \pycsp med. De to tidsmodeller er implementeret i Python som to selvstændige versioner af \pycsp der begge bygger oven på \code{greenlets}-versionen. 
